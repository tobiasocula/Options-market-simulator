...
def run(params: Params, save=False, savedir=None):
    ...
    for T_current in range(1, T):
        ...
        intensities = compute_intensities(trades, assetdata[0, T_current], params.dt * T_current, M, N, T_current) # (M, N, 2)
        ...
        for _ in range(num_events):
            ...
            for t in new_trades:
                ...
                print('adding new trade in all trades')
    ...
    if save:
        ...
        return orderbooks, assetdata, overviews, trades, all_trades, intensities_keep